...
export default {
  ...
  methods: {
    ...
    //筛选请求
    getScreeningLists(warningLevelId) {
      var api = "/plugin/psychosocialService/serviceItems/findServiceitemsForMobile.action";
      this.$http
        .post(api, {
          // 当前所选的组织机构id
          ...
          // 本次只做精神病人员
          "serviceItemsVo.populaitionType": 'mentalPatient',
          // 预警等级
